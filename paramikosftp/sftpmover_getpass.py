...
def main():
    ...
    new_folder = input("what folder would you like to put your moved files in?")
    ## Make an SFTP connection object
    sftp = paramiko.SFTPClient.from_transport(t)
    sftp.mkdir(new_folder) 
    ## copy our firstpasswd.py script to bender
    sftp.put("file_to_move.txt", new_folder+"/file_to_move.txt") # move file to target location home directory
